...
namespace frydom {
  ...
  FrIrrApp<OffshoreSystemType>::FrIrrApp(FrOffshoreSystem<OffshoreSystemType> *frSystem, chrono::ChSystem *system, double dist)
  ...
  template<typename OffshoreSystemType>
  FrIrrApp<OffshoreSystemType>::~FrIrrApp() = default;
  ...
  // -----------------------------------------------------------------------------
  template<typename OffshoreSystemType>
  void FrIrrApp<OffshoreSystemType>::SetSkyBox() {
    cppfs::FilePath resources_path(std::string(RESOURCES_VIZU_PATH));
  ...
  template<typename OffshoreSystemType>
  FrIrrCamera *FrIrrApp<OffshoreSystemType>::AddCustomCamera(irr::core::vector3df mpos, irr::core::vector3df mtarg) {
  ...
  template<typename OffshoreSystemType>
  void FrIrrApp<OffshoreSystemType>::AddCustomLights(irr::core::vector3df pos1, irr::core::vector3df pos2,
  ...
  template<typename OffshoreSystemType>
  void FrIrrApp<OffshoreSystemType>::Run(double endTime) {
    ...
    while (GetDevice()->run()) {
      ...
      if (endTime > 0. && m_system->GetTime() > endTime)
  ...
  template<typename OffshoreSystemType>
  void FrIrrApp<OffshoreSystemType>::Visualize() {
    AssetBindAll();
    AssetUpdateAll();
  ...
  template<typename OffshoreSystemType>
  void FrIrrApp<OffshoreSystemType>::VisualizeStaticAnalysis() {
    AssetBindAll();
    AssetUpdateAll();
