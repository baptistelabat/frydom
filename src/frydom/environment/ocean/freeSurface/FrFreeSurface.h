  ...
  class FrFreeSurface : public FrObject {
   ...
   public:
    ...
    FrAiryRegularWaveField *SetAiryRegularWaveField(double waveHeight, double wavePeriod, double waveDirAngle,
                                                    mathutils::ANGLE_UNIT unit, FRAME_CONVENTION fc,
    ...
    SetAiryRegularWaveField(double waveHeight, double wavePeriod, const Direction &waveDirection,
    ...
    SetAiryRegularOptimWaveField(double waveHeight, double wavePeriod, const Direction &waveDirection,
                                 FRAME_CONVENTION fc, DIRECTION_CONVENTION dc);
