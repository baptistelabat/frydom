...
namespace frydom {
  ...
  FrWaveField::GetElevation(const std::vector<double> &xVect, const std::vector<double> &yVect,
...
//    }
  ...
  FrNullWaveField::GetComplexElevation(double x, double y, FRAME_CONVENTION fc) const {
