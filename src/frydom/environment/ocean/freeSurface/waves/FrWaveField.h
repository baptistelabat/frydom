...
namespace frydom {
     ...
     */
    template<typename OffshoreSystemType>
    class FrWaveField : public FrObject<OffshoreSystemType> {
...
//      };
     ...
     protected:
      ...
      FrFreeSurface<OffshoreSystemType> *m_freeSurface;        ///< Pointer to the free surface containing this wave field
//      WAVE_MODEL m_waveModel = NO_WAVES;    ///< wave model (NO_WAVES, LINEAR_WAVES)
     ...
     public:
      ...
      explicit FrWaveField(FrFreeSurface<OffshoreSystemType> *freeSurface);
...
//      WAVE_MODEL GetWaveModel() const;
      ...
      GetWaveDirections(ANGLE_UNIT unit, FRAME_CONVENTION fc, DIRECTION_CONVENTION dc) const = 0;
     ...
     */
    template<typename OffshoreSystemType>
    class FrNullWaveField : public FrWaveField<OffshoreSystemType> {

     public:
      explicit FrNullWaveField(FrFreeSurface<OffshoreSystemType> *freeSurface);
