...
namespace frydom {
    ...
    namespace internal {
        ...
        FrSystemBaseSMC<OffshoreSystemType>::FrSystemBaseSMC(
            frydom::FrOffshoreSystem<OffshoreSystemType> *offshoreSystem) :
...
//        }
    ...
    template<typename OffshoreSystemType>
    FrOffshoreSystem<OffshoreSystemType>::FrOffshoreSystem(SYSTEM_TYPE systemType, TIME_STEPPER timeStepper,
                                                           SOLVER solver) {
...
//        m_message = std::make_unique<hermes::Message>();
    ...
    // ***** Physics Item *****
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::AddPhysicsItem(
        std::shared_ptr<FrPrePhysicsItem<OffshoreSystemType>> otherPhysics) {
    ...
    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::PrePhysicsContainer
    FrOffshoreSystem<OffshoreSystemType>::GetPrePhysicsItemList() {
      return m_PrePhysicsList;
    }

    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::AddPhysicsItem(
        std::shared_ptr<FrMidPhysicsItem<OffshoreSystemType>> otherPhysics) {
      m_chronoSystem->AddOtherPhysicsItem(otherPhysics->GetChronoPhysicsItem());
      otherPhysics->m_system = this;
    ...
    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::MidPhysicsContainer
    FrOffshoreSystem<OffshoreSystemType>::GetMidPhysicsItemList() {
      return m_MidPhysicsList;
    }

    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::AddPhysicsItem(
        std::shared_ptr<FrPostPhysicsItem<OffshoreSystemType>> otherPhysics) {
      m_chronoSystem->AddOtherPhysicsItem(otherPhysics->GetChronoPhysicsItem());
      otherPhysics->m_system = this;
    ...
    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::PostPhysicsContainer
    FrOffshoreSystem<OffshoreSystemType>::GetPostPhysicsItemList() {
      return m_PostPhysicsList;
    }

    template<typename OffshoreSystemType>
    void
    FrOffshoreSystem<OffshoreSystemType>::RemovePhysicsItem(std::shared_ptr<FrPhysicsItem<OffshoreSystemType>> item) {
    ...
    // ***** FEAMesh *****
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::AddFEAMesh(std::shared_ptr<FrFEAMesh<OffshoreSystemType>> feaMesh) {
    ...
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::Add(std::shared_ptr<FrDynamicCable<OffshoreSystemType>> cable) {
      ...
      // Add the hinges
      m_chronoSystem->Add(
          dynamic_cast<internal::FrDynamicCableBase<OffshoreSystemType> *>(cable->GetChronoMesh().get())->m_startingHinge);
      m_chronoSystem->Add(
          dynamic_cast<internal::FrDynamicCableBase<OffshoreSystemType> *>(cable->GetChronoMesh().get())->m_endingHinge);

    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::FEAMeshContainer
    FrOffshoreSystem<OffshoreSystemType>::GetFEAMeshList() {
      return m_feaMeshList;
    }

    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::RemoveFEAMesh(std::shared_ptr<FrFEAMesh<OffshoreSystemType>> feamesh) {
    ...
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::Remove(std::shared_ptr<FrDynamicCable<OffshoreSystemType>> cable) {
    ...
    // ***** Environment *****
    template<typename OffshoreSystemType>
    FrEnvironment<OffshoreSystemType> *FrOffshoreSystem<OffshoreSystemType>::GetEnvironment() const {
      return m_environment.get();
    }

    template<typename OffshoreSystemType>
    std::shared_ptr<FrBody<OffshoreSystemType>> FrOffshoreSystem<OffshoreSystemType>::GetWorldBody() const {
      return m_worldBody;
    }
    ...
    void FrOffshoreSystem<OffshoreSystemType>::Initialize() {
      ...
      // Init the logs
      if (this->IsLogged()) {
        this->m_pathManager->Initialize(this);
        this->m_pathManager->SetRunPath("Dynamic");
        this->InitializeLog("");
      }
    ...
    template<typename OffshoreSystemType>
    bool
    FrOffshoreSystem<OffshoreSystemType>::CheckBodyContactMethod(std::shared_ptr<FrBody<OffshoreSystemType>> body) {
    ...
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::SetContactForceModel(
        FrOffshoreSystem<OffshoreSystemType>::CONTACT_MODEL model) {
      if (m_systemType == SMOOTH_CONTACT) {
    ...
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::SetAdhesionForceModel(
        FrOffshoreSystem<OffshoreSystemType>::ADHESION_MODEL model) {
      if (m_systemType == SMOOTH_CONTACT) {
        auto systemSMC = dynamic_cast<chrono::ChSystemSMC *>(m_chronoSystem.get());
    ...
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::SetTangentialDisplacementModel(
        FrOffshoreSystem<OffshoreSystemType>::TANGENTIAL_DISP_MODEL model) {
      if (m_systemType == SMOOTH_CONTACT) {
        auto systemSMC = dynamic_cast<chrono::ChSystemSMC *>(m_chronoSystem.get());
    ...
    template<typename OffshoreSystemType>
    FrStaticAnalysis<OffshoreSystemType> *FrOffshoreSystem<OffshoreSystemType>::GetStaticAnalysis() const {
    ...
    template<typename OffshoreSystemType>
    void FrOffshoreSystem<OffshoreSystemType>::Relax(typename FrStaticAnalysis<OffshoreSystemType>::RELAXTYPE relax) {

      for (auto &body:m_bodyList) {
        switch (relax) {
          case FrStaticAnalysis<OffshoreSystemType>::NORELAX :
            break;
          case FrStaticAnalysis<OffshoreSystemType>::VELOCITY :
            body->SetVelocityInWorldNoRotation(Velocity(), NWU);
            break;
          case FrStaticAnalysis<OffshoreSystemType>::ACCELERATION :
            body->SetAccelerationInBodyNoRotation(Acceleration(), NWU);
            break;
          case FrStaticAnalysis<OffshoreSystemType>::VELOCITYANDACCELERATION :
            body->SetVelocityInWorldNoRotation(Velocity(), NWU);
            body->SetAccelerationInBodyNoRotation(Acceleration(), NWU);
            break;
        }
    ...
    void FrOffshoreSystem<OffshoreSystemType>::CreateWorldBody() {
      m_worldBody = std::make_shared<FrBody<OffshoreSystemType>>();
    ...
    template<typename OffshoreSystemType>
    std::shared_ptr<FrBody<OffshoreSystemType>> FrOffshoreSystem<OffshoreSystemType>::NewBody() {
      auto body = std::make_shared<FrBody<OffshoreSystemType>>();  // TODO : suivant le type de systeme SMC ou NSC, regler le type de surface...
    ...
    // Iterators
    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::BodyIter FrOffshoreSystem<OffshoreSystemType>::body_begin() {
      return m_bodyList.begin();
    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::ConstBodyIter
    FrOffshoreSystem<OffshoreSystemType>::body_begin() const {
      return m_bodyList.cbegin();
    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::BodyIter FrOffshoreSystem<OffshoreSystemType>::body_end() {
      return m_bodyList.end();
    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::ConstBodyIter
    FrOffshoreSystem<OffshoreSystemType>::body_end() const {
      return m_bodyList.cend();
    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::LinkIter FrOffshoreSystem<OffshoreSystemType>::link_begin() {
      return m_linkList.begin();
    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::ConstLinkIter
    FrOffshoreSystem<OffshoreSystemType>::link_begin() const {
      return m_linkList.cbegin();
    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::LinkIter FrOffshoreSystem<OffshoreSystemType>::link_end() {
      return m_linkList.end();
    }

    template<typename OffshoreSystemType>
    typename FrOffshoreSystem<OffshoreSystemType>::ConstLinkIter
    FrOffshoreSystem<OffshoreSystemType>::link_end() const {
...
//            m_environment->InitializeLog();
        ...
        for (auto &item : m_PrePhysicsList) {
          item->SetPathManager(this->GetPathManager());
    ...
    void FrOffshoreSystem<OffshoreSystemType>::AddFields() {
      ...
      this->m_message->template AddField<int>("iter", "", "number of total iterations taken by the solver", [this]() {
      ...
      if (dynamic_cast<chrono::ChIterativeSolver *>(m_chronoSystem->GetSolver().get())->GetRecordViolation()) {
        ...
        this->m_message->template AddField<double>("violationResidual", "", "constraint violation", [this]() {
          return dynamic_cast<chrono::ChIterativeSolver *>(m_chronoSystem->GetSolver().get())->GetViolationHistory().back();
        });

        this->m_message->template AddField<double>("LagrangeResidual", "", "maximum change in Lagrange multipliers",
                                                   [this]() {
    ...
    std::string FrOffshoreSystem<OffshoreSystemType>::GetDataPath(const std::string &relPath) const {
      return this->GetPathManager()->GetDataPath(relPath);
    }

    template<typename OffshoreSystemType>
    std::string FrOffshoreSystem<OffshoreSystemType>::BuildPath(const std::string &rootPath) {

      auto objPath = fmt::format("{}_{}", GetTypeName(), this->GetShortenUUID());
