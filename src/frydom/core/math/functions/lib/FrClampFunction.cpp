...
namespace frydom {
    ...
    FrClampAfterFunction::FrClampAfterFunction(const FrFunctionBase &function, double xClamp) : FrClampFunction(function, xClamp) {}
    ...
    FrClampBeforeFunction::FrClampBeforeFunction(const FrFunctionBase &function, double xClamp) : FrClampFunction(function, xClamp) {}
