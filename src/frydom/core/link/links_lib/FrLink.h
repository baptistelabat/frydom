...
//        DISTANCETOAXIS,
    ...
    namespace internal {
        ...
        struct FrLinkLockBase : public chrono::ChLinkLock {
          ...
          FrLink<OffshoreSystemType> *m_frydomLink; ///> Pointer to frydom link object container
          ...
          /// Constructor
          explicit FrLinkLockBase(FrLink<OffshoreSystemType> *frydomLink);
     ...
     */
    template<typename OffshoreSystemType>
    class FrLink : public FrLinkBase<OffshoreSystemType> {

     protected:

      std::shared_ptr<internal::FrLinkLockBase<OffshoreSystemType>> m_chronoLink;

      FrFrame m_frame2WRT1_reference;
      bool m_breakable = false; // TODO : utiliser et permettre de declencher la cassure de la liaison

      // Actuator
      std::shared_ptr<FrActuator<OffshoreSystemType>> m_actuator;

     public:

      /// Constructor taking the nodes attached to the two bodies implied in the link and the system
      FrLink(const std::shared_ptr<FrNode<OffshoreSystemType>> &node1,
     ...
     protected:
      ...
      void SetNodes(FrNode<OffshoreSystemType> *node1, FrNode<OffshoreSystemType> *node2);
      ...
      internal::FrLinkLockBase<OffshoreSystemType> *GetChronoItem_ptr() const override;
