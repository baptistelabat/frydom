...
//    }  // end namespace frydom::internal
    ...
    template<typename OffshoreSystemType>
    class FrActuator : public FrLinkBase<OffshoreSystemType> {

     protected:
//        std::shared_ptr<internal::FrMotorBase> m_chronoMotor;

      FrLink<OffshoreSystemType> *m_actuatedLink;


     public:

      explicit FrActuator(FrLink<OffshoreSystemType> *actuatedLink);
