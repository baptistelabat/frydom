...
namespace frydom {
     ...
     */
    template<typename OffshoreSystemType>
    class FrPrismaticLink : public FrLink<OffshoreSystemType> {
     ...
     public:
      ...
      FrPrismaticLink(std::shared_ptr<FrNode<OffshoreSystemType>> node1,
      ...
      FrLinearActuator<OffshoreSystemType> *Motorize(ACTUATOR_CONTROL control);
    ...
    make_prismatic_link(std::shared_ptr<FrNode<OffshoreSystemType>> node1,
                        std::shared_ptr<FrNode<OffshoreSystemType>> node2,
