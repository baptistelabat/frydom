...
namespace frydom {
    ...
    void FrDOFMaskLink<OffshoreSystemType>::SetDOFMask(FrDOFMask *mask) {
      this->m_chronoLink->SetMask(mask);
    }

    template<typename OffshoreSystemType>
    FrDOFMaskLink<OffshoreSystemType>::FrDOFMaskLink(const std::shared_ptr<FrNode<OffshoreSystemType>> &node1,
