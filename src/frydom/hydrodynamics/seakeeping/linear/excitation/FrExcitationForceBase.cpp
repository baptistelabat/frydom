...
namespace frydom {
    ...
    void FrExcitationForceBase::Initialize() {
    ...
    FrExcitationForceBase::GetHDBInterp(std::vector<double> waveFrequencies,
    ...
    void FrExcitationForceBase::BuildHDBInterpolators() {
    ...
    void FrExcitationForceBase::Compute_F_HDB(){
