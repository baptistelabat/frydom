...
namespace frydom {
    ...
    void FrHydroDB<OffshoreSystemType>::SetWaveDirectionDiscretization(const double minAngle, const double maxAngle,
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::SetTimeDiscretization(const double finalTime, const unsigned int nbTimeSamples) {
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::SetFrequencyDiscretization(const double minFreq, const double maxFreq,
    ...
    template<typename OffshoreSystemType>
    std::vector<double> FrHydroDB<OffshoreSystemType>::GetWaveDirections(mathutils::ANGLE_UNIT angleUnit, FRAME_CONVENTION fc) const {
    ...
    template<typename OffshoreSystemType>
    FrBEMBody<OffshoreSystemType> *FrHydroDB<OffshoreSystemType>::NewBody(std::string bodyName) {
      m_bodies.push_back(std::make_unique<FrBEMBody<OffshoreSystemType>>(GetNbBodies(), bodyName, this));
      return m_bodies.back().get();
    }

    template<typename OffshoreSystemType>
    FrBEMBody<OffshoreSystemType> *FrHydroDB<OffshoreSystemType>::GetBody(std::shared_ptr<FrBody<OffshoreSystemType>> body) {
      return m_mapper->GetBEMBody(body.get());
    }

    template<typename OffshoreSystemType>
    FrBEMBody<OffshoreSystemType> *FrHydroDB<OffshoreSystemType>::GetBody(FrBody<OffshoreSystemType> *body) {
      return m_mapper->GetBEMBody(body);
    }

    template<typename OffshoreSystemType>
    FrBEMBody<OffshoreSystemType> *FrHydroDB<OffshoreSystemType>::GetBody(int ibody) {
      return m_bodies[ibody].get();
    }

    template<typename OffshoreSystemType>
    FrBody<OffshoreSystemType> *FrHydroDB<OffshoreSystemType>::GetBody(FrBEMBody<OffshoreSystemType> *body) {
      return m_mapper->GetBody(body);
    }

    template<typename OffshoreSystemType>
    FrHydroMapper<OffshoreSystemType> *FrHydroDB<OffshoreSystemType>::GetMapper() {
      return m_mapper.get();
    }

    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::Map(FrBEMBody<OffshoreSystemType> *BEMBody, FrBody<OffshoreSystemType> *body, std::shared_ptr<FrEquilibriumFrame<OffshoreSystemType>> eqFrame) {
      m_mapper->Map(BEMBody, body, eqFrame);
    }

    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::Map(int iBEMBody, FrBody<OffshoreSystemType> *body, std::shared_ptr<FrEquilibriumFrame<OffshoreSystemType>> eqFrame) {
      m_mapper->Map(m_bodies[iBEMBody].get(), body, eqFrame);
    }

    template<typename OffshoreSystemType>
    typename std::unordered_map<FrBEMBody<OffshoreSystemType> *, FrBody<OffshoreSystemType> *>::iterator FrHydroDB<OffshoreSystemType>::begin() {
      return m_mapper->begin();
    };

    template<typename OffshoreSystemType>
    typename std::unordered_map<FrBEMBody<OffshoreSystemType> *, FrBody<OffshoreSystemType> *>::iterator FrHydroDB<OffshoreSystemType>::end() {
      return m_mapper->end();
    };

    template<typename OffshoreSystemType>
    FrHydroDB<OffshoreSystemType>::FrHydroDB(std::string h5file) {
      ...
      m_mapper = std::make_unique<FrHydroMapper<OffshoreSystemType>>();
      ...
      auto NbWaveDir = reader.ReadInt(
          wave_direction_discretization_path + "/NbWaveDirections"); // Number of wave directions.
      ...
      this->SetWaveDirectionDiscretization(MinWaveDir, MaxWaveDir,
                                           (uint) NbWaveDir); // Settings the wave direction discretization.
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::MaskReader(FrHDF5Reader &reader, std::string path, FrBEMBody<OffshoreSystemType> *BEMBody) {
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::ModeReader(FrHDF5Reader &reader, std::string path, FrBEMBody<OffshoreSystemType> *BEMBody) {
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::ExcitationReader(FrHDF5Reader &reader, std::string path, FrBEMBody<OffshoreSystemType> *BEMBody) {
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::RadiationReader(FrHDF5Reader &reader, std::string path, FrBEMBody<OffshoreSystemType> *BEMBody) {
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::WaveDriftReader(FrHDF5Reader &reader, std::string path, FrBEMBody<OffshoreSystemType> *BEMBody) {
    ...
    template<typename OffshoreSystemType>
    void FrHydroDB<OffshoreSystemType>::HydrostaticReader(FrHDF5Reader &reader, std::string path, FrBEMBody<OffshoreSystemType> *BEMBody) {
    ...
    template<typename OffshoreSystemType>
    std::shared_ptr<FrHydroDB<OffshoreSystemType>> make_hydrodynamic_database(std::string h5file) {
      ...
      return std::make_shared<FrHydroDB<OffshoreSystemType>>(h5file);
    }
