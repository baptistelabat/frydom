...
namespace frydom {
    ...
    template<typename OffshoreSystemType>
    std::shared_ptr<FrMorisonCompositeElement<OffshoreSystemType>> make_morison_model(FrBody<OffshoreSystemType> *body);
    ...
    class FrMorisonElement {
     ...
     protected:
      std::shared_ptr<FrNode<OffshoreSystemType>> m_node;   ///< Frame at the center position of the morison element with z-axis along its direction
     ...
     public:
      ...
      void
      SetFrame(FrBody<OffshoreSystemType> *body, Position posA, Position posB, Direction vect = Direction(0., 0., 1.));

      /// Set the local frame of the morison model from another frame
      /// \param body Body to which the frame is attached
      /// \param frame Other frame
      void SetFrame(FrBody<OffshoreSystemType> *body, const FrFrame &frame);
      ...
      /// \return Node
      std::shared_ptr<FrNode<OffshoreSystemType>> GetNode() const { return m_node; }
    ...
    template<typename OffshoreSystemType>
    class FrMorisonSingleElement : public FrMorisonElement<OffshoreSystemType> {

     protected:
      std::shared_ptr<FrNode<OffshoreSystemType>> m_nodeA;               ///< First extremity node of the morison element
      std::shared_ptr<FrNode<OffshoreSystemType>> m_nodeB;               ///< Second extremity node of the morison element
     ...
     public:
      ...
      explicit FrMorisonSingleElement(FrBody<OffshoreSystemType> *body);
      ...
      FrMorisonSingleElement(std::shared_ptr<FrNode<OffshoreSystemType>> &nodeA,
      ...
      /// \param cf Friction coefficient
      /// \param perpendicular x-axis is built such as is perpendicular to the morison element direction and this vector
      FrMorisonSingleElement(FrBody<OffshoreSystemType> *body, Position posA, Position posB,
                             double diameter, MorisonCoeff ca, MorisonCoeff cd, double cf,
                             Direction perpendicular = Direction(0., 0., 1.));
      ...
      /// \param cf Friction coefficient
      FrMorisonSingleElement(FrBody<OffshoreSystemType> *body, FrFrame frame, double diameter, double length,
      ...
      void
      SetNodes(std::shared_ptr<FrNode<OffshoreSystemType>> &nodeA, std::shared_ptr<FrNode<OffshoreSystemType>> &nodeB);
      ...
      void SetNodes(FrBody<OffshoreSystemType> *body, Position posA, Position posB);
    ...
    template<typename OffshoreSystemType>
    class FrMorisonCompositeElement : public FrMorisonElement<OffshoreSystemType> {

     protected:
      std::vector<std::unique_ptr<FrMorisonElement<OffshoreSystemType>>> m_morison;      ///< morison model components of the composite model
     ...
     public:
      ...
      explicit FrMorisonCompositeElement(FrBody<OffshoreSystemType> *body);

      /// Constructor of a new composite model of the morison force with frame local frame
      /// \param body BOdy to which the morison model is applied
      /// \param frame Local frame
      FrMorisonCompositeElement(FrBody<OffshoreSystemType> *body, FrFrame &frame);

      /// Add a new morison model to the composite model
      /// \param model Morison model (can be single or composite elements)
      void AddElement(FrMorisonElement<OffshoreSystemType> *model) {
        m_morison.push_back(std::unique_ptr<FrMorisonElement<OffshoreSystemType>>(model));
      }
      ...
      /// \param perpendicular x-axis is built such as is perpendicular to the morison element direction and this vector
      void
      AddElement(std::shared_ptr<FrNode<OffshoreSystemType>> &nodeA, std::shared_ptr<FrNode<OffshoreSystemType>> &nodeB,
                 double diameter, MorisonCoeff ca, MorisonCoeff cd, double cf,
                 Direction perpendicular = Direction(0., 0, 1.));
