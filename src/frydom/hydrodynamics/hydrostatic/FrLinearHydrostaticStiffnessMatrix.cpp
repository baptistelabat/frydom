...
namespace frydom {
  ...
  void FrLinearHydrostaticStiffnessMatrix::SetK34(double K34) {
    m_data.at(0, 1) = K34;
    m_data.at(1, 0) = K34;
  }

  void FrLinearHydrostaticStiffnessMatrix::SetK35(double K35) {
    m_data.at(0, 2) = K35;
    m_data.at(2, 0) = K35;
  }

  void FrLinearHydrostaticStiffnessMatrix::SetK45(double K45) {
    m_data.at(1, 2) = K45;
    m_data.at(2, 1) = K45;
  }
