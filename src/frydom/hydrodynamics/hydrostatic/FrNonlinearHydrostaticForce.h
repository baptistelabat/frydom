...
namespace frydom {
     ...
     */
    template<typename OffshoreSystemType>
    class FrNonlinearHydrostaticForce : public FrForce<OffshoreSystemType> {

     private:

      /// Hydrodynamic mesh.
      std::shared_ptr<FrHydroMesh<OffshoreSystemType>> m_hydroMesh;

     public:

      /// Constructor.
      explicit FrNonlinearHydrostaticForce(const std::shared_ptr<FrHydroMesh<OffshoreSystemType>> &HydroMesh);
