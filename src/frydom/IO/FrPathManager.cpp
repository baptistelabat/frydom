...
namespace frydom {
  ...
  FrPathManager<OffshoreSystemType>::FrPathManager() :
  ...
  template<typename OffshoreSystemType>
  void FrPathManager<OffshoreSystemType>::ReadConfig() {
  ...
  template<typename OffshoreSystemType>
  void FrPathManager<OffshoreSystemType>::Initialize(FrOffshoreSystem<OffshoreSystemType> *system) {
  ...
  template<typename OffshoreSystemType>
  void FrPathManager<OffshoreSystemType>::SetRunPath(std::string relPath) {
  ...
  template<typename OffshoreSystemType>
  std::string FrPathManager<OffshoreSystemType>::GetRunPath() const {
    return m_runPath.path();
  }

  template<typename OffshoreSystemType>
  void FrPathManager<OffshoreSystemType>::SetLogFrameConvention(FRAME_CONVENTION fc) {
    m_logFrameConvention = fc;
  }

  template<typename OffshoreSystemType>
  FRAME_CONVENTION FrPathManager<OffshoreSystemType>::GetLogFrameConvention() const {
    return m_logFrameConvention;
  }

  template<typename OffshoreSystemType>
  void FrPathManager<OffshoreSystemType>::SetLogOutputPath(std::string path) {
    m_outputPath = path;
  }

  template<typename OffshoreSystemType>
  std::string FrPathManager<OffshoreSystemType>::GetLogOutputPath() const {
    return m_outputPath.path();
  }

  template<typename OffshoreSystemType>
  std::string FrPathManager<OffshoreSystemType>::BuildPath(const std::string &rootPath, const std::string &relPath) const {
  ...
  template<typename OffshoreSystemType>
  std::string FrPathManager<OffshoreSystemType>::BuildPath(const std::string &absPath) const {
  ...
  template<typename OffshoreSystemType>
  void FrPathManager<OffshoreSystemType>::SetResourcesPath(std::string absPath) {
    m_resourcesPath.setPath(absPath);
  }

  template<typename OffshoreSystemType>
  std::string FrPathManager<OffshoreSystemType>::GetDataPath(const std::string &relPath) const {
