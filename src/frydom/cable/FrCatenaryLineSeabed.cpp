...
//      FrCatenaryLine::solve();
  ...
  Position FrCatenaryLineSeabed::GetPositionInWorld(double s, FRAME_CONVENTION fc) const {
    assert(0. <= s);
  ...
  Force FrCatenaryLineSeabed::GetTension(double s, FRAME_CONVENTION fc) const {
