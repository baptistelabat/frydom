...
namespace frydom {
     ...
     */
    template<typename OffshoreSystemType>
    class FrHydroMesh : public FrPrePhysicsItem<OffshoreSystemType> {
     ...
     public:
      ...
      /// Constructor.
      FrHydroMesh(FrOffshoreSystem<OffshoreSystemType> *system, const std::shared_ptr<FrBody<OffshoreSystemType>> &body,
                  FrHydroMesh::ClippingSupport support);

      /// Constructor.
      FrHydroMesh(FrOffshoreSystem<OffshoreSystemType> *system, const std::shared_ptr<FrBody<OffshoreSystemType>> &body,
                  const std::string &meshFile,
                  FrFrame meshOffsset, FrHydroMesh::ClippingSupport support);
     ...
     private:
      ...
      FrOffshoreSystem<OffshoreSystemType> *m_system;                     ///< reference to the offshore system
      std::shared_ptr<FrBody<OffshoreSystemType>> m_body;                 ///< reference to the body related to this FrHydroMesh
