...
namespace frydom {
    ...
    mesh::FrClippingSurface::FrClippingSurface(double meanHeight) : m_meanHeight(meanHeight) {}

    void mesh::FrClippingSurface::SetMeanHeight(const double &meanHeight) {
        m_meanHeight = meanHeight;
    }

    void mesh::FrClippingSurface::SetBodyPosition(Position bodyPos) {
            m_bodyPosition = bodyPos;
    }

    // -----------------------------------------------------------------------------------------------------------------

    mesh::FrClippingPlane::FrClippingPlane(double meanHeight) : FrClippingSurface(meanHeight) {}

    VectorT<double, 3> mesh::FrClippingPlane::GetIntersection(const VectorT<double, 3> &p0, const VectorT<double, 3> &p1) {
    ...
    mesh::FrClippingWaveSurface::FrClippingWaveSurface(const double &meanHeight, FrFreeSurface *FreeSurface) : FrClippingSurface(meanHeight) {
        m_freesurface = FreeSurface;
    }

    VectorT<double, 3>
    mesh::FrClippingWaveSurface::GetIntersection(const VectorT<double, 3> &p0, const VectorT<double, 3> &p1) {
    ...
    double mesh::FrClippingWaveSurface::GetDistance(const VectorT<double, 3> &point) const {
    ...
    mesh::FrMeshClipper::FrMeshClipper() {
        m_clippingSurface = std::make_unique<FrClippingPlane>(0.);
    }

    mesh::FrClippingSurface* mesh::FrMeshClipper::GetClippingSurface() {
        return m_clippingSurface.get();
    }

    void mesh::FrMeshClipper::Apply(mesh::FrMesh* mesh) {
    ...
    void mesh::FrMeshClipper::SetProjectionThresholdRatio(double projectionThresholdRatio) {
        m_ProjectionThresholdRatio = projectionThresholdRatio;
    }

    void mesh::FrMeshClipper::SetEps(double eps) {
        m_Threshold = eps;
    }

    void mesh::FrMeshClipper::SetPlaneClippingSurface(const double &meanHeight) {

        m_clippingSurface = std::make_unique<FrClippingPlane>(meanHeight);

    }

    void mesh::FrMeshClipper::SetWaveClippingSurface(const double &meanHeight, FrFreeSurface *FreeSurface) {

        m_clippingSurface = std::make_unique<FrClippingWaveSurface>(meanHeight,FreeSurface);

    }

    void mesh::FrMeshClipper::Initialize() {
    ...
    void mesh::FrMeshClipper::ClassifyVertices() {
...
//            ProcessFace(face);
    ...
    void mesh::FrMeshClipper::UpdateModifiedFaceProperties(FaceHandle fh) {
    ...
    bool mesh::FrMeshClipper::HasProjection(const FaceHandle &fh) {
    ...
    mesh::VertexPosition mesh::FrMeshClipper::ClassifyVertex(const VertexHandle &vh) const {
    ...
    mesh::FacePositionType mesh::FrMeshClipper::ClassifyFace(const FaceHandle &fh) { // TODO: renvoyer le resultat !!
    ...
    void mesh::FrMeshClipper::ProcessFace(const FaceHandle &fh) {
...
//                    UpdateModifiedFaceProperties(fh);
    ...
    void mesh::FrMeshClipper::ProcessHalfEdge(HalfedgeHandle heh) {
    ...
    void mesh::FrMeshClipper::FlagFaceToBeDeleted(const FaceHandle &fh) {
    ...
    void mesh::FrMeshClipper::FlagVertexAdjacentFacesToBeDeleted(const VertexHandle &vh) {
    ...
    bool mesh::FrMeshClipper::IsEdgeCrossing(const EdgeHandle &eh) {
    ...
    bool mesh::FrMeshClipper::IsHalfEdgeCrossing(const HalfedgeHandle &heh) {
    ...
    bool mesh::FrMeshClipper::IsHalfEdgeDownCrossing(const HalfedgeHandle &heh) {
    ...
    bool mesh::FrMeshClipper::IsHalfEdgeUpCrossing(const HalfedgeHandle &heh) {
    ...
    HalfedgeHandle mesh::FrMeshClipper::FindUpcrossingHalfEdge(const FaceHandle &fh) {
    ...
    HalfedgeHandle mesh::FrMeshClipper::FindDowncrossingHalfEdge(const FaceHandle &fh) {
    ...
    VertexHandle mesh::FrMeshClipper::InsertIntersectionVertex(const HalfedgeHandle &heh) {
    ...
    double mesh::FrMeshClipper::GetVertexDistanceToSurface(const VertexHandle &vh) const {
    ...
    void mesh::FrMeshClipper::ApplyFaceDeletion() {
    ...
    void mesh::FrMeshClipper::Finalize() {
