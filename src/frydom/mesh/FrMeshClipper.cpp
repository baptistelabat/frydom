...
namespace frydom {
  ...
  namespace mesh { // TODO : parametrer le meshClipper avec un templage clippingSurface !!
    ...
    VectorT<double, 3>
    FrClippingWaveSurface<OffshoreSystemType>::GetIntersection(const VectorT<double, 3> &p0,
                                                               const VectorT<double, 3> &p1) {
    ...
    template<typename OffshoreSystemType>
    double FrClippingWaveSurface<OffshoreSystemType>::GetDistance(const VectorT<double, 3> &point) const {
