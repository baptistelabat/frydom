        ...
        */
        class FrClippingSurface {
         ...
         protected:
          ...
          Position m_bodyPosition = {0., 0.,
                                     0.};   ///< horizontal position of the body, related to the mesh to be clipped
        ...
        */
        ...
        class FrClippingWaveSurface : public FrClippingSurface {
         ...
         private:
          ...
          FrFreeSurface<OffshoreSystemType> *m_freeSurface;   ///< free surface used for clipping

         public:

          explicit FrClippingWaveSurface(FrFreeSurface<OffshoreSystemType> *freeSurface) : m_freeSurface(
              freeSurface) {};
