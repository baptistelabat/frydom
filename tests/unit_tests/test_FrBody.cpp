...
//    std::cout<<"+++++TranslateInBody"<<std::endl;
  ...
  Rotation1.SetCardanAngles_DEGREES(90., 0., 0., NWU);
  FrRotation Rotation2;
  Rotation2.SetCardanAngles_DEGREES(0., 90., 0., NWU);
...
TEST(FrBodyTest, Orientation) {
  ...
  BodyRotationInWorld.SetCardanAngles_DEGREES(1., 2., 3., NWU);
...
//    Test_AllGetRotation(body, BodyRotationInWorld);
  ...
  //-----------------Rotation-----------------//
  //+++++Rotate+++++//
  FrRotation NewRotation;
  NewRotation.SetCardanAngles_DEGREES(4., 8., 3., NWU);
  ...
  //+++++RotateAroundCOG+++++//
  FrRotation RotationAroundCOG;
  RotationAroundCOG.SetCardanAngles_DEGREES(8., 6., 2., NWU);
  ...
  FrRotation RotationAroundPointInWorld;
  RotationAroundPointInWorld.SetCardanAngles_DEGREES(1., 9., 7., NWU);
  ...
  FrRotation RotationAroundPointInBody;
  RotationAroundPointInBody.SetCardanAngles_DEGREES(1., 9., 7., NWU);
...
//    std::cout<<body->GetVelocityInBody(fc)<<std::endl;
  ...
  //-----------------PointInBody-----------------//
  Position PointInBody(5., 6., 7.);
  Position PointInWorld(7., 6., 5.);
...
//    std::cout<<"SetGeneralizedVelocityInWorldAtPointInWorld"<<std::endl;
  ...
  body->SetGeneralizedVelocityInWorldAtPointInWorld(PointInWorld, VelocityInWorldAtPointInWorld, BodyAngularVelocity,
                                                    fc);
...
//    std::cout<<"SetGeneralizedVelocityInWorldAtPointInWorld"<<std::endl;
  Velocity VelocityInWorldAtPointInWorld(3., 1., 5.);
  body->SetGeneralizedVelocityInWorldAtPointInWorld(PointInWorld, VelocityInWorldAtPointInWorld, AngularVelocityInWorld,
                                                    fc);
...
//    std::cout<<"SetGeneralizedVelocityInWorldAtPointInBody"<<std::endl;
  Velocity VelocityInWorldAtPointInBody(2., 1., 8.);
  body->SetGeneralizedVelocityInWorldAtPointInBody(PointInBody, VelocityInWorldAtPointInBody, AngularVelocityInWorld,
                                                   fc);

  VelocityInWorld = VelocityInWorldAtPointInBody -
                    AngularVelocityInWorld.cross(
                        body->GetPointPositionInWorld(PointInBody, fc) - body->GetPosition(fc));
  Test_AllGetVelocity(body, VelocityInWorld, AngularVelocityInWorld, is_orientation, fc);
...
//    std::cout<<"SetGeneralizedVelocityInBodyAtPointInWorld"<<std::endl;
  const Velocity VelocityInBodyAtPointInWorld(8., 1., 9.);
  body->SetGeneralizedVelocityInBodyAtPointInWorld(PointInWorld, VelocityInBodyAtPointInWorld, AngularVelocityInBody,
                                                   fc);

  VelocityInWorld =
      EasyRotate(VelocityInBodyAtPointInWorld, fc) - AngularVelocityInWorld.cross(PointInWorld - body->GetPosition(fc));
  Test_AllGetVelocity(body, VelocityInWorld, AngularVelocityInWorld, is_orientation, fc);
...
TEST(FrBodyTest, Acceleration) {
  ...
  Test_AllGetAcceleration(body, AccelerationInWorld, AngularAccelerationInWorld, AngularVelocityInWorld, is_orientation,
                          fc);
  ...
  Test_AllGetAcceleration(body, AccelerationInBody, AngularAccelerationInWorld, AngularVelocityInWorld, is_orientation,
                          fc);
