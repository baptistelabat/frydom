...
class TestQuadraticDamping : public ::testing::Test {
 ...
 protected:
  ...
  TestQuadraticDamping() : system("TestQuadraticDamping") {}
...
void TestQuadraticDamping::SetUp() {
  ...
  force = make_quadratic_damping_force("current_quadratic_damping", body, FLUID_TYPE::WATER, false);
...
TEST_F(TestQuadraticDamping, TestWindVelocity) {
  ...
  auto windDamping = make_quadratic_damping_force("wind_quadratic_damping", body, FLUID_TYPE::AIR, true);
