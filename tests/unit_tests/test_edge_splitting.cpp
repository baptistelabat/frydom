...
FrMesh::VertexHandle AddIntersectionPoint(FrMesh& mesh, const FrMesh::HalfedgeHandle& heh) {  // TODO : definir une classe de plan (ou de surface de maniere plus generale)
