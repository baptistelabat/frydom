...
//    freeSurface->SetGrid(0, 0, 300, 25, 30);
  ...
  platform->SetInertiaXX(chrono::ChVector<double>(1.02e11 * 2, 1.34e11 * 2, 1.28e11 *
                                                                            2)); // Attention, le *2 partout ici est pour emuler la masse ajoutee...
...
//    platform->Set3DOF_ON(); // Activate if you want it to stay in the horizontal plane
  ...
  auto radiationModel = std::make_shared<FrRadiationConvolutionModel>(&HDB,
                                                                      &system); // TODO: changer en linearHydroModel...
  ...
  app.SetVideoframeSave(
      generateVideo);  // TODO: decelencher la generation de la video de maniere auto en post-processing...
