...
//
//    FrInertiaTensor inertia(mass,Ixx,Iyy,Izz,0,0,0,Position(),NWU);
//    cylinder->SetInertiaTensor(inertia);
    ...
    decayRot.SetCardanAngles_DEGREES(0.,0.,0.,NWU);
...
//    auto CylinderMesh = make_hydro_mesh(cylinder, "Free_cylinder_11600_panels.obj", meshOffset, FrHydroMesh::ClippingSupport::PLANESURFACE);
