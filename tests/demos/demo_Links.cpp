...
int main(int argc, char *argv[]) {
  ...
  */
  ...
  FrOffshoreSystem system("demo_Links");
  ...
  auto suppBody = system.NewBody("suppBody");
  ...
  auto movingToSuppNode = movingBody->NewNode("movingToSuppNode");
  movingToSuppNode->SetPositionInWorld(Position(6, 0, 0), fc);

  auto suppNode = suppBody->NewNode("suppNode");

  auto fixedLinkBetweenMovingAndSuppBodies = make_fixed_link("fixedLinkBetweenMovingAndSuppBodies", &system,
                                                             movingToSuppNode, suppNode);


  enum demo_cases {
    Cylindrical, Revolute, Spherical, Prismatic
  };
  ...
  switch (featuredCase) {
    case Cylindrical: {
      ...
      fixedRotation.RotX_DEGREES(5, fc);
      ...
      auto constraint = make_cylindrical_link("cylindrical", &system, fixedNode, movingNode);
    ...
    case Revolute: {
      ...
      auto constraint = make_revolute_link("revolute", &system, fixedNode, movingNode);
    ...
    case Spherical: {
      ...
      FrRotation movingRotation;
      movingRotation.RotX_DEGREES(45, fc); // just to see more rotations
      ...
      auto constraint = make_spherical_link("spherical", &system, fixedNode, movingNode);
    ...
    case Prismatic: {
      ...
      auto constraint = make_prismatic_link("prismatic", &system, fixedNode, movingNode);
