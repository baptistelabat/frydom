...
class WaveDriftDB(object):
    ...
    def modes(self):
        ...
        """This subroutine gives the modes of the polar coefficients.
    ...
    def sym_x(self):
        ...
        """This subroutine indicates if a symmetry in the plane xOZ is present.
    ...
    def sym_x(self, value):
        ...
        """This subroutine sets presence of a symmetry along x.
    ...
    def sym_y(self):
        ...
        """This subroutine indicates if a symmetry along y is present.
    ...
    def sym_y(self, value):
        ...
        """This subroutine sets presence of a symmetry along y.
    ...
    def heading_index(self):
        ...
        """This subroutine gives the heading index.
    ...
    def discrete_wave_dir(self):
        ...
        """This subroutine gives the wave direction discretization.
    ...
    def discrete_wave_dir(self, value):
        ...
        """This subroutine sets the wave direction vector.
    ...
    def discrete_frequency(self):
        ...
        """This subroutine gives the frequency discretization.
    ...
    def scaling_mode(self, mode, factor):
        ...
        """This subroutine scales the polar coefficients.
    ...
    def add(self, mode, freq, data, wave_dir, unit_freq='rads', unit_dir='rad'):
        ...
        """This subroutine adds the polar coefficients.
    ...
    def add_cx(self, freq, data, wave_dir, unit_freq='rads', unit_dir='rad'):
        ...
        """This subroutine adds the cx (surge) polar coefficients.
    ...
    def add_cy(self, freq, data, wave_dir, unit_freq='rads', unit_dir='rad'):
        ...
        """This subroutine adds the cy (sway) polar coefficients.
    ...
    def add_cz(self, freq, data, wave_dir, unit_freq='rads', unit_dir='rad'):
        ...
        """This subroutine adds the cz (heave) polar coefficients.
    ...
    def add_cr(self, freq, data, wave_dir, unit_freq='rads', unit_dir='rad'):
        ...
        """This subroutine adds the cr (roll) polar coefficients.
    ...
    def add_cm(self, freq, data, wave_dir, unit_freq='rads', unit_dir='rad'):
        ...
        """This subroutine adds the cm (pitch) polar coefficients.
    ...
    def add_cn(self, freq, data, wave_dir, unit_freq='rads', unit_dir='rad'):
        ...
        """This subroutine adds the cn (yaw) polar coefficients.
    ...
    def _set_discrete_frequency(self):
        ...
        """This subroutine sets the frequency vector.
        """
    ...
    def initialize(self):
        ...
        """
        This subroutine sorts the data with respect to the wave direction according to an increasing order and interpolates the data wrt the frequencies and the wave directions.
        """
    ...
    def get_structure(self):
        ...
        """
        This subroutine prints the modes, the headings and the frequencies.
        """
